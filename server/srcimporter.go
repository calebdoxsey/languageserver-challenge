...
// I copied this so I could fill the token fileset, which I couldn't figure out how to do in the time alloted with the current libraries
...
func NewImporter(ctxt *build.Context, fset *token.FileSet, packages map[string]*types.Package) *Importer {
	return &Importer{
		ctxt:     ctxt,
		fset:     fset,
